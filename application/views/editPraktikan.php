...
<body>  
  <div class="container">
    ...
    <?php endif;?>
    <form method="POST" action="<?php echo base_url();?>praktikan/updateData" enctype="multipart/form-data">                        
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Edit Data Praktikan </h6>
        </div>
        <div class="card-body">
          <input type="hidden" name="id_prak" value="<?php echo $praktikan->id_prak;?>">
